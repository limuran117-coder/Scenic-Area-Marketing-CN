...
| Tab | 平台 | 用途 |
|-----|------|------|
| Tab0 | 小红书灵犀后台 | 搜索总量/关联词 |
| Tab1 | 抖音搜索 | 爆款视频发现 |
| Tab2 | 微博/临时导航 | 微博热搜/行业热点（免登录） |
| Tab3 | 百度搜索 | 竞品营收/客量/媒体报道 |
| Tab4 | 抖音指数核心页 ⭐ | 日报订阅 + 关键词分析 |
| Tab5 | 小红书探索页 | 爆款笔记 |
...
1. 在当前context新建page使用
2. 抓取：热搜榜单/话题阅读量/讨论量
3. 筛选：与文旅/景区/郑州/开封相关的热点
...
### **6/30 CDP 18800 浏览器 Tab 状态**

| Tab | 用途 | 6/30 状态 |
|-----|------|----------|
| Tab0 | 小红书灵犀后台 | ⚠️ not_logged_in 需站长扫码 |
| Tab1 | 抖音搜索页 | ✅ 正常 |
| Tab2 | 空白页 | — |
| Tab3 | 百度搜索 | ✅ 正常 |
| Tab4 | 抖音指数核心页 | ✅ 正常（采集完成） |
| Tab5 | 小红书探索页 | ⚠️ 需登录 |
| Tab6 | 微博热搜 | ✅ 正常 |
...
- 浏览器维护 SOP：`wiki/SOP/专属浏览器维护SOP.md`
