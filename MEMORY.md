...
**重要修正（2026-06-15纠正）：
- 原记录「2026端午=6/3」错误，正确=6/19（周五）
- 原记录「6/1-6/5为调休」待核实，需重新确认
- 所有端午相关判断以本条为准

**日期基准（2026-06-15最终确认）**
- `Downloads/电影小镇-2026年数量统计(2).xlsx` col154=6月1日
- 6月19端午（正确参考数据以历史行为准）
- **历史参考行**（第1-3行）=2023/2024/2025年同日数据，勿与2026年合计行混用
- 2026年数据从6/1起，历史数据参考同列位置

**对比框架（2026-06-15确认）**
- 月度对比：2026年X月 vs 2025/2024/2023年同月
- 季度对比：Q1/Q2/Q3/Q4 各自与往年同季度比
- 半年对比：H1/H2 vs 往年H1/H2
- 全年对比：YTD vs 年目标/往年全年
- **所有对比都是历史行为准，不用serial推断未来日期
