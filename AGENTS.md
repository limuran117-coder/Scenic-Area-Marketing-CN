...
## 周度技能探索 2026-09-05
- 环境快照：scripts/ 101 个，系统技能 52 个，核心 CLI（gh/curl/jq/ffmpeg）在位，无缺失
- 候选观测：无新增 CLI/技能缺口；现有链路（douyin_index v11 / xiaohongshu_crawl / feishu 卡片）稳定
- 上线前提：无（本周无需试点新工具，保持现状即可）
